...
#ifndef BTL_USNIC_OPAL_IF_UTIL_
#define BTL_USNIC_OPAL_IF_UTIL_
...
#define BTL_USNIC_OPAL_IF_FORMAT_ADDR(n)                              \
    (((n) >> 24) & 0x000000FF), (((n) >> 16) & 0x000000FF), \
    (((n) >> 8) & 0x000000FF), ((n) & 0x000000FF)

#define BTL_USNIC_OPAL_IF_ASSEMBLE_NETWORK(n1, n2, n3, n4)    \
    (((n1) << 24) & 0xFF000000) |                   \
    (((n2) << 16) & 0x00FF0000) |                   \
    (((n3) <<  8) & 0x0000FF00) |                   \
    ( (n4)        & 0x000000FF)        
 ...
 */
OPAL_DECLSPEC int btl_usnic_opal_ifnametoaddr(const char* if_name, 
 ...
 */
OPAL_DECLSPEC int btl_usnic_opal_ifaddrtoname(const char* if_addr, 
 ...
 */
OPAL_DECLSPEC int btl_usnic_opal_ifnametoindex(const char* if_name);
 ...
 */
OPAL_DECLSPEC int16_t btl_usnic_opal_ifnametokindex(const char* if_name);
 ...
 *  @return              Interface kernel index
 */
OPAL_DECLSPEC int btl_usnic_opal_ifindextokindex(int if_index);

/**
 *  Returns the number of available interfaces.
 */
OPAL_DECLSPEC int btl_usnic_opal_ifcount(void);

/**
 *  Returns the index of the first available interface.
 */
OPAL_DECLSPEC int btl_usnic_opal_ifbegin(void); 
 ...
 *                    current position.
 */
OPAL_DECLSPEC int btl_usnic_opal_ifnext(int if_index);
 ...
 *  @param size (IN)      Interface name buffer size
 */
OPAL_DECLSPEC int btl_usnic_opal_ifindextoname(int if_index, char* if_name, int);
 ...
 *  @param size (IN)      Interface name buffer size
 */
OPAL_DECLSPEC int btl_usnic_opal_ifkindextoname(int if_kindex, char* if_name, int);
 ...
 *  @param size (IN)      Interface address buffer size
 */
OPAL_DECLSPEC int btl_usnic_opal_ifindextoaddr(int if_index, struct sockaddr*,
                                     unsigned int);
 ...
 *  @param size (IN)      Interface address buffer size
 */
OPAL_DECLSPEC int btl_usnic_opal_ifindextomask(int if_index, uint32_t*, int);
 ...
 *  @param size (IN)      Interface address buffer size
 */
OPAL_DECLSPEC int btl_usnic_opal_ifindextomac(int if_index, uint8_t mac[6]);
 ...
 */
OPAL_DECLSPEC int btl_usnic_opal_ifindextoflags(int if_index, uint32_t*);
 ...
 */
OPAL_DECLSPEC bool btl_usnic_opal_ifislocal(const char *hostname);
 ...
 */
OPAL_DECLSPEC int btl_usnic_opal_iffinalize(void);
 ...
 * @return OPAL_ERROR if data could not be released
 */
OPAL_DECLSPEC int btl_usnic_opal_iftupletoaddr(char *addr, uint32_t *net, uint32_t *mask);
 ...
 *  @param if_index (IN)  Interface index
 */
OPAL_DECLSPEC bool btl_usnic_opal_ifisloopback(int if_index);
